            ...
            <div className="md:col-span-1">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Record a new activity for your field.</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={addLog} className="space-y-4">
                    <div>
                      <label htmlFor="activity" className="mb-2 block text-sm font-medium">Activity</label>
                      <Input
                        id="activity"
                        value={activity}
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="e.g., On the north field"
                      />
                    </div>
