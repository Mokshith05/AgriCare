...
const translations: Record<string, Record<string, any>> = {
  en: {
    ...
    dashboard: {
      ...
      weatherDescription: 'Conditions for your crops',
      sunny: 'Sunny',
      humidity: 'Humidity',
      uvIndex: 'UV Index',
      high: 'High',
  ...
  hi: {
    ...
    dashboard: {
      ...
      weatherDescription: 'आपकी फसलों के लिए शर्तें',
      sunny: 'धूप',
      humidity: 'नमी',
  ...
  te: {
    ...
    dashboard: {
      ...
      weatherDescription: 'మీ పంటల కోసం పరిస్థితులు',
      sunny: 'ఎండ',
      humidity: 'తేమ',
      uvIndex: 'UV సూచిక',
      high: 'అధిక',
  ...
  ta: {
    ...
    dashboard: {
      ...
      weatherDescription: 'உங்கள் பயிர்களுக்கான நிலைமைகள்',
      sunny: 'வெயில்',
      humidity: 'ஈரப்பதம்',
